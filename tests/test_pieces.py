...
class TestPawns:
    ...
    @staticmethod
    def test_white_king_not_capture_friendly_piece():
        # Arrange
        board = Board.empty()
        king = King(Player.WHITE)
        king_square = Square.at(3,3)
        ...
        friend1 = Pawn(Player.WHITE)
        friend1_square = Square.at(3,4)
        board.set_piece(friend1_square, friend1)
